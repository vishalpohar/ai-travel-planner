...
export const buildTripPrompt = ({ destination, durationDays, budgetTier, interests, weather, }) => `
...
`;
export const buildDayPrompt = ({ destination, budgetTier, interests, dayNumber, instruction, }) => `
